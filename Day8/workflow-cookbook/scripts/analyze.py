...
DEFAULT_LOG = Path("Day8/workflow-cookbook/logs/test.jsonl")
REPORT_PATH = Path("Day8/workflow-cookbook/reports/day8/ci/summary.md")
ISSUE_PATH = Path("Day8/workflow-cookbook/reports/day8/ci/issues.md")
BIRDSEYE_PATH = Path("Day8/workflow-cookbook/reports/day8/ci/birdseye.json")
FlowEntry = TypedDict(
