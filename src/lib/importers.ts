  ...
  for (const ln of lines){
    try{
      ...
      if (i != null){
        ...
        next.scenes.push({ id, manual: mode==='manual'? String(o.text||''):'', ai: mode==='ai'? String(o.text||''):'', status:'idle', seed: seed, tone:o.tone, assets: [], slate:o.slate, shot:o.shot, take: take })
